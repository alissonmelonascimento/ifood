package com.github.alissonmelonascimento.ifood.cadastro.panache;
...
public class PanacheQueries {
	...
	public void exemplosSelects() {
		...
		PanacheQuery<Restaurante> page = findAll.page(Page.of(3, 10));//3 pagina com 10 registros
		//page.nextPage(); proxima pagina
		//page.count(); total de registros
		...
		// Atalho para findAll.stream, mas precisa de transacao se nao o cursor pode
		// fechar antes
		...
		Restaurante.delete("nome = :nome and id = :id", Parameters.with("nome", "").and("id", 1L));
...
//primeira forma de mapear entidades. PanacheEntity define o id. sugerido pelo quarkus
@Entity
class MinhaEntidade1 extends PanacheEntity {
	public String nome;
}

//segunda forma de mapear entidades. PanacheEntityBase nao define o id. sugerido pelo quarkus
@Entity
...
//terceira forma de mapear entidades. Cria-se um pojo, mapeia as colunas e criar uma classe Repositorio que tera as operacoes do CRUD
